...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv(r"C:\hackathon bms\Testing.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv(r"C:\hackathon bms\Training.csv")
...
w2 = Label(root, justify=LEFT, text="INNOV HEALTH", fg="white", bg="black")
